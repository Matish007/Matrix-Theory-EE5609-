...
\begin{align}
\angle{ABQ}=\angle{ABP}\\
\cos\angle{ABQ}=\cos\angle{ABP}\\
\frac{(\vec{B}-\vec{A})^T(\vec{B}-\vec{Q})}{\norm{\vec{B}-\vec{A}}\norm{\vec{B}-\vec{Q}}}=\frac{(\vec{B}-\vec{A})^T(\vec{B}-\vec{P})}{\norm{\vec{B}-\vec{A}}\norm{\vec{B}-\vec{P}}}
\end{align}
Now,multiplying both sides by $((\vec{A}-\vec{B})^T)^{-1}$ we get,
\begin{align}
    \frac{(\vec{B}-\vec{Q})}{\norm{\vec{B}-\vec{Q}}}=\frac{(\vec{B}-\vec{P})}{\norm{\vec{B}-\vec{P}}}\label{5}
\end{align}
By \eqref{5} we can say that $\vec{B}$ is equidistant from the arms of $\angle{A}$,where $\vec{P}$ and $\vec{Q}$ represents points on the arms of $\angle{A}$ 
\begin{align}
    \therefore BP=BQ\label{6}
\end{align}
Using \eqref{1},\eqref{2},\eqref{6} and AAS(Angle Angle Side) property of congruency we can say that:-
\begin{align}
