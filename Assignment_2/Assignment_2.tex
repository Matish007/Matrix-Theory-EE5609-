...
\begin{align}
    ...
    \abs{c}=7\sqrt{70}\\
    c=+7\sqrt{70}  , -7\sqrt{70}
\end{align}\\
Substituting equation (1),(7) in (2) we get,
\begin{align}
    \boxed{\begin{pmatrix}3 & 5 & -6\end{pmatrix}\mathbf{x}=7\sqrt{70}}\\
     \boxed{\begin{pmatrix}3 & 5 & -6\end{pmatrix}\mathbf{x}=-7\sqrt{70}}
\end{align}
Equation 8,9 gives us the equation of two planes which are at a distance of 7 units from origin and normal to $\begin{pmatrix}3\\5\\-6\end{pmatrix}$
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\columnwidth]{plane 1.png}
	\caption{Plane1}
	\label{myfig2}
\end{figure}
\begin{figure}[h!]
	\centering
	\includegraphics[width=\columnwidth]{plane 2.png}
	\caption{Plane2}
	\label{myfig2}
\end{figure}
\end{document}