...
\begin{lstlisting}
https://github.com/Matish007/Matrix-Theory-EE5609-/tree/master/Assignment_15
\end{lstlisting}
%
%
\vspace{0.5mm}
\section{Problem}
The row space of a $20 \times 50$ matrix $\vec{A}$ has dimension 13.What is the dimension of the space of solution $\vec{Ax}=0$?
\begin{enumerate}
\item{7}
\item{13}
\item{33}
