...
$\myvec{0&0\\0&0}$ has no basis so it's rank is 0.\\
$\myvec{1&0\\0&0}$ has $\myvec{1\\0}$ as basis.\\
$\myvec{0&1\\0&0}$ has $\myvec{1\\0}$ as basis.\\
$\myvec{1&1\\0&0}$ have two basis {$\myvec{1\\0}$,$\myvec{1\\0}$}\\
$\myvec{1&1\\0&1}$ have two basis {$\myvec{1\\0}$,$\myvec{0\\1}$}
